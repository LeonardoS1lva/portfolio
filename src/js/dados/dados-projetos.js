const projetos = [
    ...
    {
        id: 20,
        nome: "Gerador de Senhas Aleatórias",
        nomeArquivoImg: "preview-Gerador-de-Senhas.png",
        textoAlternativo: "Gerador de Senhas",
        descricao: "Gerador de senhas aleatórias com opção de escolha de tamanho.",
        tecnologias: ["html", "css", "javascript"],
        nomeRepositorio: "Gerador-de-Senhas",
        online: true,
        download: false,
        status: "Online",
        linkOnline: "https://leonardos1lva.github.io/Gerador-de-Senhas/",
    },
    {
        id: 21,
        nome: "Gerador de QR Code",
        nomeArquivoImg: "preview-gerador-de-qrcode.png",
        textoAlternativo: "Gerador de QR Code",
        descricao: "Transforma textos ou links digitados no campo de texto em um QR Code.",
        tecnologias: ["html", "bootstrap", "javascript"],
        nomeRepositorio: "Gerador-de-QRCode",
        online: true,
        download: false,
        status: "Online",
        linkOnline: "https://leonardos1lva.github.io/gerador-de-qrcode/",
    },
    {
        id: 22,
        nome: "Fake Pinterest",
        nomeArquivoImg: "preview-fake-pinterest.png",
        textoAlternativo: "Fake Pinterest",
        descricao: "Projeto de um site semelhante ao Pinterest, com a funcionalidade de Login, perfil e adicionar novas imagens.",
    ...
    {
        id: 23,
        nome: "Lista de Tarefas em React",
        nomeArquivoImg: "preview-to-do-react.png",
        textoAlternativo: "Lista de Tarefas em React",
        descricao: "Projeto de uma lista de tarefas, com opção de adicionar, remover, marcar como concluída e importação/exportação de tarefas.",
        tecnologias: ["react"],
        nomeRepositorio: "to-do-react",
        online: true,
        download: false,
        status: "Online",
        linkOnline: "https://to-do-react-liard-chi.vercel.app/",
    },
    {
        id: 24,
        nome: "Lista de Tarefas em TypeScript",
        nomeArquivoImg: "preview-crud-typescript.png",
        textoAlternativo: "Lista de Tarefas em TypeScript",
        descricao: "Versão em  typescript do projeto de lista de tarefas feito para estudos em TypeScript.",
        tecnologias: ["bootstrap", "typescript"],
        nomeRepositorio: "crud-typescript",
        online: true,
        download: false,
        status: "Online",
        linkOnline: "https://crud-typescript-gamma.vercel.app/",
    }
];